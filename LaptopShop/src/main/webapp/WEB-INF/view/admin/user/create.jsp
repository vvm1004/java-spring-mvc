                    ...
                    <div class="col-md-6 col-12 mx-auto">
                      ...
                      <form:form method="post" action="/admin/user/create" modelAttribute="newUser" class="row"
                        ...
                        <div class="mb-3 col-12 col-md-6">
                          ...
                          <input class="form-control" type="file" id="avatarFile" accept=".png, .jpg, .jpeg" name="vvm1004File"/>
                        </div>
                        <div class="mb-3 col-12">
                          <img id="avatarPreview" style="max-height: 250px; display: none;" src="" alt="Avatar preview">
                        </div>
